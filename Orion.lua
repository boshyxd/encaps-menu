...
local function L_15_func(L_39_arg1, L_40_arg2)
	pcall(function()
		...
		L_14_func(L_39_arg1.InputBegan, function(L_45_arg1)
			if
				L_45_arg1.UserInputType == Enum.UserInputType.MouseButton1
				or L_45_arg1.UserInputType == Enum.UserInputType.Touch
			then
				L_41_ = true
		...
		L_14_func(L_39_arg1.InputChanged, function(L_46_arg1)
			if
				L_46_arg1.UserInputType == Enum.UserInputType.MouseMovement
				or L_46_arg1.UserInputType == Enum.UserInputType.Touch
			then
				L_42_ = L_46_arg1
			end
		end)
		L_14_func(L_2_.InputChanged, function(L_47_arg1)
			if L_47_arg1 == L_42_ and L_41_ then
				...
				L_40_arg2.Position =
					UDim2.new(L_44_.X.Scale, L_44_.X.Offset + L_48_.X, L_44_.Y.Scale, L_44_.Y.Offset + L_48_.Y)
			end
		end)
	end)
end
...
local L_31_ = L_19_func(
	L_20_func(L_18_func("TFrame"), {
...
function L_10_:MakeNotification(L_121_arg1)
	task.spawn(function()
		...
		local L_123_ = L_20_func(
			L_19_func(L_18_func("RoundFrame", Color3.fromRGB(25, 25, 25), 0, 10), {
				Parent = L_122_,
				Size = UDim2.new(1, 0, 0, 0),
...
function L_10_:Init()
	pcall(function()
		if
			L_10_.SaveCfg
			and getfenv().isfile
			and getfenv().readfile
			and getfenv().isfile(string.format("%s/%s.txt", L_10_["Folder"], game.PlaceId))
		then
...
function L_10_:MakeWindow(L_124_arg1)
	...
	if
		L_124_arg1.SaveConfig
		and getfenv().isfolder
		and getfenv().makefolder
		and not getfenv().isfolder(L_124_arg1.ConfigFolder)
	then
		getfenv().makefolder(L_124_arg1.ConfigFolder)
	end
	local L_128_ = L_23_func(
		L_20_func(
			L_19_func(L_18_func("ScrollFrame", Color3.fromRGB(255, 255, 255), 4), {
	...
	local L_129_ = L_20_func(
		L_19_func(L_18_func("Button"), {
		...
		{
			L_23_func(
				L_19_func(L_18_func("Image", "rbxassetid://7072725342"), {
	...
	local L_130_ = L_20_func(
		...
		{
			L_23_func(
				L_19_func(L_18_func("Image", "rbxassetid://7072719338"), {
					Position = UDim2.new(0, 9, 0, 6),
					Size = UDim2.new(0, 18, 0, 18),
					Name = "Ico",
				}),
	...
	local L_132_ = L_23_func(
		L_20_func(
			L_19_func(L_18_func("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
				Size = UDim2.new(0, 150, 1, -50),
				Position = UDim2.new(0, 0, 0, 50),
			}),
			{
				L_23_func(
					L_19_func(L_18_func("Frame"), {
				...
				L_20_func(
					...
					}),
					{
						...
						L_23_func(
							L_20_func(
								...
								}),
								{
									...
									L_23_func(
										L_19_func(L_18_func("Image", "rbxassetid://4031889928"), {
											Size = UDim2.new(1, 0, 1, 0),
										}),
										"Second"
									),
						...
						L_23_func(
							L_19_func(L_18_func("Label", L_5_.DisplayName, L_124_arg1.TestMode and 13 or 14), {
						...
						L_23_func(
							L_19_func(L_18_func("Label", "Tester", 12), {
	...
	local L_133_ = L_23_func(
		L_19_func(L_18_func("Label", L_124_arg1.Name, 14), {
			...
			}),
			{
				L_20_func(
					...
					}),
					{
						...
						L_23_func(
							L_20_func(
								L_19_func(L_18_func("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 7), {
	...
	function L_137_:MakeTab(L_142_arg1)
		...
		local L_143_ = L_20_func(
			...
			{
				L_23_func(
					L_19_func(L_18_func("Image", L_142_arg1.Icon), {
						AnchorPoint = Vector2.new(0, 0.5),
						Size = UDim2.new(0, 18, 0, 18),
						Position = UDim2.new(0, 10, 0.5, 0),
				...
				L_23_func(
					L_19_func(L_18_func("Label", L_142_arg1.Name, 14), {
		...
		local L_144_ = L_23_func(
			L_20_func(
				L_19_func(L_18_func("ScrollFrame", Color3.fromRGB(255, 255, 255), 5), {
		...
		local function L_145_func(L_152_arg1)
			...
			function L_153_:AddLabel(L_155_arg1)
				local L_156_ = L_23_func(
					L_20_func(
						L_19_func(L_18_func("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
							Size = UDim2.new(1, 0, 0, 30),
						...
						{
							L_23_func(
								L_19_func(L_18_func("Label", L_155_arg1, 15), {
			...
			function L_153_:AddParagraph(L_159_arg1, L_160_arg2)
				...
				local L_161_ = L_23_func(
					L_20_func(
						...
						{
							L_23_func(
								L_19_func(L_18_func("Label", L_159_arg1, 15), {
			...
			function L_153_:AddButton(L_164_arg1)
				...
				local L_167_ = L_23_func(
					L_20_func(
						...
						{
							L_23_func(
								L_19_func(L_18_func("Label", L_164_arg1.Name, 15), {
									Size = UDim2.new(1, -12, 1, 0),
									Position = UDim2.new(0, 12, 0, 0),
									Font = Enum.Font.GothamBold,
									Name = "Content",
							...
							L_23_func(
								L_19_func(L_18_func("Image", L_164_arg1.Icon), {
									Size = UDim2.new(0, 20, 0, 20),
				...
				L_14_func(L_166_.MouseEnter, function()
					L_3_:Create(L_167_, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
						BackgroundColor3 = Color3.fromRGB(
							L_10_.Themes[L_10_.SelectedTheme].Second.R * 255 + 3,
							L_10_.Themes[L_10_.SelectedTheme].Second.G * 255 + 3,
							L_10_.Themes[L_10_.SelectedTheme].Second.B * 255 + 3
						),
					}):Play()
				end)
				...
				L_14_func(L_166_.MouseButton1Down, function()
					L_3_:Create(L_167_, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
						BackgroundColor3 = Color3.fromRGB(
							L_10_.Themes[L_10_.SelectedTheme].Second.R * 255 + 6,
							L_10_.Themes[L_10_.SelectedTheme].Second.G * 255 + 6,
							L_10_.Themes[L_10_.SelectedTheme].Second.B * 255 + 6
						),
					}):Play()
				end)
			...
			function L_153_:AddToggle(L_169_arg1)
				...
				local L_172_ = L_20_func(
					L_19_func(L_18_func("RoundFrame", L_169_arg1.Color, 0, 4), {
				...
				local L_173_ = L_23_func(
					L_20_func(
						...
						{
							L_23_func(
								L_19_func(L_18_func("Label", L_169_arg1.Name, 15), {
									Size = UDim2.new(1, -12, 1, 0),
									Position = UDim2.new(0, 12, 0, 0),
									Font = Enum.Font.GothamBold,
									Name = "Content",
			...
			function L_153_:AddSlider(L_175_arg1)
				...
				local L_177_ = false
				local L_178_ = L_20_func(
					L_19_func(L_18_func("RoundFrame", L_175_arg1.Color, 0, 5), {
					...
					{
						L_23_func(
							L_19_func(L_18_func("Label", "value", 13), {
								Size = UDim2.new(1, -12, 0, 14),
				...
				L_23_func(
					L_20_func(
						L_19_func(L_18_func("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 4), {
							Size = UDim2.new(1, 0, 0, 65),
							Parent = L_152_arg1,
						}),
						{
							L_23_func(
								L_19_func(L_18_func("Label", L_175_arg1.Name, 15), {
									Size = UDim2.new(1, -12, 0, 14),
									Position = UDim2.new(0, 12, 0, 10),
									Font = Enum.Font.GothamBold,
									Name = "Content",
				...
				L_179_.InputBegan:Connect(function(L_180_arg1)
					if
						L_180_arg1.UserInputType == Enum.UserInputType.MouseButton1
						or L_180_arg1.UserInputType == Enum.UserInputType.Touch
					then
						L_177_ = true
					end
				end)
				L_179_.InputEnded:Connect(function(L_181_arg1)
					if
						L_181_arg1.UserInputType == Enum.UserInputType.MouseButton1
						or L_181_arg1.UserInputType == Enum.UserInputType.Touch
					then
						L_177_ = false
					end
				end)
				function L_176_:Set(L_182_arg1)
					...
					L_3_
						:Create(L_178_, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
							Size = UDim2.fromScale(
								(L_182_arg1 - L_175_arg1.Min) / (L_175_arg1.Max - L_175_arg1.Min),
								1
							),
						})
						:Play()
				...
				L_2_.InputChanged:Connect(function(L_183_arg1)
					if
						L_177_
						and (
							L_183_arg1.UserInputType == Enum.UserInputType.MouseMovement
							or L_183_arg1.UserInputType == Enum.UserInputType.Touch
						)
					then
						local L_184_ = math.clamp(
							(L_183_arg1.Position.X - L_179_.AbsolutePosition.X) / L_179_.AbsoluteSize.X,
							0,
							1
						)
			...
			function L_153_:AddDropdown(L_185_arg1)
				...
				local L_189_ = L_23_func(
					L_19_func(
						L_20_func(L_18_func("ScrollFrame", Color3.fromRGB(40, 40, 40), 4), {
							L_188_,
						}),
						{
							Parent = L_152_arg1,
					...
					L_20_func(
						...
						}),
						{
							...
							L_19_func(
								L_20_func(L_18_func("TFrame"), {
									L_23_func(
										L_19_func(L_18_func("Label", L_185_arg1.Name, 15), {
											Size = UDim2.new(1, -12, 1, 0),
											Position = UDim2.new(0, 12, 0, 0),
											Font = Enum.Font.GothamBold,
											Name = "Content",
									...
									L_23_func(
										L_19_func(L_18_func("Image", "rbxassetid://7072706796"), {
											Size = UDim2.new(0, 20, 0, 20),
											AnchorPoint = Vector2.new(0, 0.5),
									...
									L_23_func(
										L_19_func(L_18_func("Label", "Selected", 13), {
				...
				local function L_192_func(L_193_arg1)
					for _, L_195_forvar2 in next, L_193_arg1 do
						local L_196_ = L_23_func(
							L_19_func(
								L_20_func(L_18_func("Button", Color3.fromRGB(40, 40, 40)), {
									L_18_func("Corner", 0, 6),
									L_23_func(
										L_19_func(L_18_func("Label", L_195_forvar2, 13, 0.4), {
				...
				function L_186_:Set(L_201_arg1)
					...
					L_3_:Create(
						L_186_.Buttons[L_201_arg1].Title,
						TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{
							TextTransparency = 0,
						}
				...
				L_14_func(L_190_.MouseButton1Down, function()
					...
					if #L_186_.Options > L_187_ then
						L_3_
							:Create(L_191_, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
								Size = L_186_.Toggled and UDim2.new(1, 0, 0, 38 + L_187_ * 28)
									or UDim2.new(1, 0, 0, 38),
							})
							:Play()
					else
						L_3_:Create(L_191_, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
							Size = L_186_.Toggled and UDim2.new(1, 0, 0, L_188_.AbsoluteContentSize.Y + 38)
								or UDim2.new(1, 0, 0, 38),
						}):Play()
					end
				end)
			...
			function L_153_:AddBind(L_206_arg1)
				...
				local L_210_ = L_23_func(
					L_20_func(
						...
						}),
						{
							L_23_func(L_18_func("Stroke"), "Stroke"),
							L_23_func(
								L_19_func(L_18_func("Label", L_206_arg1.Name, 14), {
									Size = UDim2.new(1, 0, 1, 0),
									Font = Enum.Font.GothamBold,
									TextXAlignment = Enum.TextXAlignment.Center,
									Name = "Value",
				...
				local L_211_ = L_23_func(
					L_20_func(
						...
						{
							L_23_func(
								L_19_func(L_18_func("Label", L_206_arg1.Name, 15), {
									Size = UDim2.new(1, -12, 1, 0),
									Position = UDim2.new(0, 12, 0, 0),
									Font = Enum.Font.GothamBold,
									Name = "Content",
				...
				L_14_func(L_209_.InputEnded, function(L_212_arg1)
					if
						(
							L_212_arg1.UserInputType == Enum.UserInputType.MouseButton1
							or L_212_arg1.UserInputType == Enum.UserInputType.Touch
						) and not L_207_.Binding
					then
						L_207_.Binding = true
						L_210_.Value.Text = ""
					end
				...
				L_14_func(L_2_.InputBegan, function(L_214_arg1)
					...
					if
						(L_214_arg1.KeyCode.Name == L_207_.Value or L_214_arg1.UserInputType.Name == L_207_.Value)
						and not L_207_.Binding
					then
				...
				L_14_func(L_2_.InputEnded, function(L_216_arg1)
					if
						(L_216_arg1.KeyCode.Name == L_207_.Value or L_216_arg1.UserInputType.Name == L_207_.Value)
						and L_206_arg1.Hold
						and L_208_
					then
						L_208_ = false
			...
			function L_153_:AddTextbox(L_217_arg1)
				...
				local L_221_ = L_23_func(
					L_20_func(
						...
						{
							L_23_func(
								L_19_func(L_18_func("Label", L_217_arg1.Name, 15), {
									Size = UDim2.new(1, -12, 1, 0),
									Position = UDim2.new(0, 12, 0, 0),
									Font = Enum.Font.GothamBold,
									Name = "Content",
			...
			function L_153_:AddColorpicker(L_222_arg1)
					...
					L_20_func(
						...
						}),
						{
							L_19_func(
								L_20_func(L_18_func("TFrame"), {
									L_23_func(
										L_19_func(L_18_func("Label", L_222_arg1.Name, 15), {
											Size = UDim2.new(1, -12, 1, 0),
											Position = UDim2.new(0, 12, 0, 0),
											Font = Enum.Font.GothamBold,
											Name = "Content",
				...
				L_223_ = 1
					- math.clamp(L_228_.AbsolutePosition.Y - L_230_.AbsolutePosition.Y, 0, L_230_.AbsoluteSize.Y)
						/ L_230_.AbsoluteSize.Y
				L_224_ = math.clamp(L_227_.AbsolutePosition.X - L_229_.AbsolutePosition.X, 0, L_229_.AbsoluteSize.X)
					/ L_229_.AbsoluteSize.X
				L_225_ = 1
					- math.clamp(L_227_.AbsolutePosition.Y - L_229_.AbsolutePosition.Y, 0, L_229_.AbsoluteSize.Y)
						/ L_229_.AbsoluteSize.Y
				local L_236_
				L_14_func(L_229_.InputBegan, function(L_239_arg1)
					if
						L_239_arg1.UserInputType == Enum.UserInputType.MouseButton1
						or L_239_arg1.UserInputType == Enum.UserInputType.Touch
					then
						if L_236_ then
							L_236_:Disconnect()
						end
						L_236_ = L_14_func(L_4_.RenderStepped, function()
							local L_240_ = math.clamp(L_6_.X - L_229_.AbsolutePosition.X, 0, L_229_.AbsoluteSize.X)
								/ L_229_.AbsoluteSize.X
							local L_241_ = math.clamp(L_6_.Y - L_229_.AbsolutePosition.Y, 0, L_229_.AbsoluteSize.Y)
								/ L_229_.AbsoluteSize.Y
				...
				L_14_func(L_229_.InputEnded, function(L_242_arg1)
					if
						(
							L_242_arg1.UserInputType == Enum.UserInputType.MouseButton1
							or L_242_arg1.UserInputType == Enum.UserInputType.Touch
						) and L_236_
					then
						L_236_:Disconnect()
					end
				...
				L_14_func(L_230_.InputBegan, function(L_243_arg1)
					if
						L_243_arg1.UserInputType == Enum.UserInputType.MouseButton1
						or L_243_arg1.UserInputType == Enum.UserInputType.Touch
					then
						if L_237_ then
							L_237_:Disconnect()
						end
						L_237_ = L_14_func(L_4_.RenderStepped, function()
							local L_244_ = math.clamp(L_6_.Y - L_230_.AbsolutePosition.Y, 0, L_230_.AbsoluteSize.Y)
								/ L_230_.AbsoluteSize.Y
				...
				L_14_func(L_230_.InputEnded, function(L_245_arg1)
					if
						(
							L_245_arg1.UserInputType == Enum.UserInputType.MouseButton1
							or L_245_arg1.UserInputType == Enum.UserInputType.Touch
						) and L_237_
					then
						L_237_:Disconnect()
					end
		...
		function L_146_:AddSection(L_246_arg1)
			...
			local L_247_ = L_20_func(
				...
				{
					L_23_func(
						L_19_func(L_18_func("Label", L_246_arg1.Name, 14), {
